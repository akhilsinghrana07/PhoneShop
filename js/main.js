...
function getProductList(products, disableTopProductSort, disableUpdateProduct){
    ...
    <div class="product__header"  >
      <img style="width: 120px;height: 651px;"src=${obj.imgUrl}  alt="product">
    </div>
    ...
    productList.forEach((obj, index)=> {
      ...
      if(obj.topProduct){
            topProducts += ` <section class="row py-2">
                              ...
                              <div class="row1">
                                <div class="column1" >
                          <img style="width: 5rem;height:5rem;" src=${obj.imgUrl} alt="" />
                          </div>
                          <div class="column2">
                            ...
                            <hr style="height:2px;width:270%;border-width:0;color:gray;background-color:gray;margin-left:-70px">
                          </div>
